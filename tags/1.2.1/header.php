				...
				<div class="wrap cf">
					<div class="header-top-contact">
						<span>
							...
							if ( get_theme_mod( 'cw_business_lite_header_title' ) != false ) {
    							echo get_theme_mod( 'cw_business_lite_header_title' );
    						} else {
    							echo _e( 'Contact Us Now: ', 'cw-business-lite' );
    						}

							?>
						</span>
						<?php
    						if ( get_theme_mod( 'cw_business_lite_header_subtitle' ) != false ) { ?>
                                <a href="tel: <?php echo get_theme_mod( 'cw_business_lite_header_subtitle' ); ?>" title="<?php echo get_theme_mod( 'cw_business_lite_header_subtitle' ); ?>"><?php echo get_theme_mod( 'cw_business_lite_header_subtitle' ); ?></a>
    						<?php } else { ?>
    							<a href="tel: <?php _e( '+1-888-846-1732', 'cw-business-lite' ); ?>" title="<?php echo get_theme_mod( 'cw_business_lite_header_subtitle' ); ?>"><?php _e( '+1-888-846-1732', 'cw-business-lite' ); ?></a>
    						<?php }
    					?>
			...
			<div class="header-shadow">
				<div class="wrap cf">
					<a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>" class="logo">
						<?php
						if ( get_theme_mod( 'cw_business_lite_header_logo' ) != false ) { ?>
