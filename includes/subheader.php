<section id="subheader" class="cf">
	<div class="wrap cf">
		<div class="subheader-content <?php if ( get_theme_mod( 'cw_business_lite_header_contactform7_shortcode' ) ) { } else { echo 'subheader-content-no-sidebar'; } ?>">
			<h3>
				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_header_title' ) ) {
					echo get_theme_mod( 'cw_business_lite_frontpage_header_title' );
				} else {
					echo _e( 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'cw-business-lite' );
				}
				?>
			</h3>
