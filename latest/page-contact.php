						...
						<div class="content cf">
							...
							<div class="contact-right">
								<div class="contact-widget">
									<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_map' ) != false ) {
									...
									<div class="contact-map">
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_map' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_map' ); ?>
										<?php } else { ?>
								...
								<div class="contact-widget">
									<div class="contact-widget-title">
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_title' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_title' );
										} else {
											echo _e( 'More about us', 'cw-business-lite' );
										}
										?>
									</div><!--/.contact-widget-title-->
									<p>
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_address1' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_address1' ) . '<br />';
										} else {
											echo _e( 'United States', 'cw-business-lite' ) . '<br />';
										}
										?>

										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_address2' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_address2' ) . '<br />';
										} else {
											echo _e( 'New York', 'cw-business-lite' ) . '<br />';
										}
										?>

										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_address3' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_address3' );
										} else {
											echo _e( '412 Broadway #2, New York, NY 10013', 'cw-business-lite' );
										}
										?>
									</p>
									<p>
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_content' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_content' );
										} else {
											echo _e( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labo ris nisi ut aliquip ex ea commodo consequat.', 'cw-business-lite' );
										}
										?>
									</p>
									<p>
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_phone' ) != false ) { ?>
											...
											<span>
												...
												<?php
												if ( get_theme_mod( 'cw_business_lite_contact_sidebar_phone' ) != false ) { ?>
													<a href="tel:<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_phone' ); ?>" title="<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_phone' ); ?>">
														<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_phone' ); ?>
													</a>
												<?php } else { ?>
										...
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_website' ) != false ) { ?>
											...
											<span>
												...
												<?php
												if ( get_theme_mod( 'cw_business_lite_contact_sidebar_website' ) != false ) {
													echo get_theme_mod( 'cw_business_lite_contact_sidebar_website' );
												} else {
													echo _e( ' <a href="" title="Movatique">Movatique</a>', 'cw-business-lite' );
												}
												?>
											</span>
										...
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_email' ) != false ) { ?>
											...
											<span>
												...
												<?php
												if ( get_theme_mod( 'cw_business_lite_contact_sidebar_email' ) != false ) { ?>
													<a href="mailto:<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_email' ); ?>" title="<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_email' ); ?>">
														<?php echo get_theme_mod( 'cw_business_lite_contact_sidebar_email' ); ?>
													</a>
												<?php } else { ?>
								...
								<div class="contact-widget">
									<div class="contact-widget-title">
										<?php
										if ( get_theme_mod( 'cw_business_lite_contact_sidebar_socials_title' ) != false ) {
											echo get_theme_mod( 'cw_business_lite_contact_sidebar_socials_title' );
										} else {
											echo _e( 'Our social network', 'cw-business-lite' );
										}
										?>
									</div><!--/.contact-widget-title-->
									<div class="contact-socials">
										<?php
										if ( get_theme_mod( 'cw_business_lite_header_youtube' ) != false ) { ?>
										...
										<?php
										if ( get_theme_mod( 'cw_business_lite_header_facebook' ) != false ) { ?>
										...
										<?php
										if ( get_theme_mod( 'cw_business_lite_header_googleplus' ) != false ) { ?>
