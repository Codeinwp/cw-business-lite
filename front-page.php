	...
	<section class="content">
		...
		<div class="our-clients">
				...
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo1',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo1',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 1" />
				<?php }
				?>

				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo2',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo2',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 2" />
				<?php }
				?>

				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo3',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo3',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 3" />
				<?php }
				?>

				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo4',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo4',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 4" />
				<?php }
				?>

				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo5',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo5',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 5" />
				<?php }
				?>

				<?php
				if ( get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo6',get_template_directory_uri().'/images/logo_default.png' ) ) { ?>
					<img src="<?php echo get_theme_mod( 'cw_business_lite_frontpage_ourclients_logo6',get_template_directory_uri().'/images/logo_default.png' ); ?>" alt="Sponsor 6" />
				<?php }
				?>
